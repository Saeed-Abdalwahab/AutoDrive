...
namespace AutoDrive.BLL.AutoMapperConfigration
{
    public class AutomapperWebProfile : Profile
    {
        public AutomapperWebProfile()
        {
            CertificationSpecDepart();
            MapperForEmployeeDepartment();
            MApperForEmployeeLicenceDate();
            MapperForemployeeQualification();
            MapperForEmployeeContractDuration();
            MapperForEmployeeExperience();
            EmployeeJobData();
            Countery();
            Area();
            Nationality();
    ...
    .ForMember(dest => dest.LicenceTypeHR, act => act.Ignore())
            ...
            CreateMap<EmployeeLicenceData, EmployeeLicenceDataVM>()
              ...
              .MapFrom(src => (src.LicenceTypeHR == null) ? "-"
    : src.LicenceTypeHR.Name))

              .ForMember(dest => dest.LicenceTypeHREnName, act => act
              .MapFrom(src => (src.LicenceTypeHR == null) ? "-"
    : src.LicenceTypeHR.EnName))
    ...
    : src.JobFunction.Name))
        ...
        public void MapperForEmployeeDepartment()
        {
            CreateMap<EmployeeDepartmentVM, EmployeeDepartment>()
                            .ForMember(dest => dest.Employee, act => act.Ignore())
                            .ForMember(dest => dest.Department, act => act.Ignore())
                            .ForSourceMember(x => x.DepartmentName, xx => xx.Ignore())
                            .ForSourceMember(x => x.DepartmentEnName, xx => xx.Ignore());


            CreateMap<EmployeeDepartment, EmployeeDepartmentVM>()
              .ForMember(dest => dest.EmployeeId, act => act.MapFrom(x => x.Employee.ID))
              .ForMember(dest => dest.DepartmentName, act => act.MapFrom(x => x.Department.Name))
              .ForMember(dest => dest.DepartmentEnName, act => act.MapFrom(x => x.Department.EnName))
              .ForMember(dest => dest.DepartmentId, act => act.MapFrom(x => x.Department.ID));
    ...
    : src.EmployeeStatu.EnName));
        ...
        public void Nationality()
        {
            CreateMap<NationalityVM, Nationality>()
                            .ForMember(dest => dest.Trainees, act => act.Ignore())
                            .ForMember(dest => dest.Employees, act => act.Ignore());
        ...
        public void Employee()
        {
            CreateMap<EmployeeVM, Employee>()
                            ...
                            .ForMember(dest => dest.Country, act => act.Ignore())
                            .ForMember(dest => dest.TraineeEvaluations, act => act.Ignore())
                            .ForMember(dest => dest.SendToTraffics, act => act.Ignore())
                            .ForMember(dest => dest.Religion, act => act.Ignore())
                            .ForMember(dest => dest.ReceiptVouchers, act => act.Ignore())
