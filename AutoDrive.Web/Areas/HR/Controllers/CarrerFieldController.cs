...
{
    public class CarrerFieldController : Controller
    {
        // GET: HR/CarrerField
        CarrerFieldService service = new CarrerFieldService();
        ...
        [HttpPost]
        public JsonResult Save(CarrerFieldVM CarrerFieldVM)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    var Mssg = CarrerFieldVM.ID == 0 ? service.Save(CarrerFieldVM) : service.Edit(CarrerFieldVM);
