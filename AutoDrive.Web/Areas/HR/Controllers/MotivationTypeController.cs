...
{
    public class MotivationTypeController : Controller
    {
        // GET: HR/MotivationType
        MotivationTypeService service = new MotivationTypeService();
        ...
        [HttpPost]
        public JsonResult Save(MotivationTypeVM MotivationTypeVM)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    var Mssg = MotivationTypeVM.ID == 0 ? service.Save(MotivationTypeVM) : service.Edit(MotivationTypeVM);
