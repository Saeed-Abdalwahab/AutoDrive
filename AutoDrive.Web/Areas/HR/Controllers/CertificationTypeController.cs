...
namespace AutoDrive.Web.Areas.HR.Controllers
{
    ...
    {
        // GET: HR/CertificationType
        CertificationTypeService service = new CertificationTypeService();
        ...
        [HttpPost]
        public JsonResult Save(CertificationTypeVM CertificationTypeVM)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    var Mssg = CertificationTypeVM.ID == 0 ? service.Save(CertificationTypeVM) : service.Edit(CertificationTypeVM);
