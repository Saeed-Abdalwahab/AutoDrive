...
namespace AutoDrive.Web.Areas.HR.Controllers
{
    ...
    {
        // GET: HR/JobName
        JobNameService service = new JobNameService();
        ...
        [HttpPost]
        public JsonResult Save(JobNameVM JobNameVM)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    var Mssg = JobNameVM.ID == 0 ? service.Save(JobNameVM) : service.Edit(JobNameVM);
